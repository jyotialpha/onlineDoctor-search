<%-- 
    Document   : docpasschange
    Created on : 24 Jul, 2023, 1:07:38 AM
    Author     : LENOVO
--%>
...
<html>
    ...
    Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","SYSTEM","Jyoti@135");
                ...
                PreparedStatement ps = con.prepareStatement("select * from d1 where PASSWORD = ?");
                ...
                if(rs.next())
                {
                    ...
                    {
                         PreparedStatement ps1 = con.prepareStatement("update d1 set PASSWORD = ? where PASSWORD = ?");
